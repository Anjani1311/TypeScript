...
//Generic
function Compare1<T>(a: T, b: T): boolean {
    //<T> denotes As Type
    return a == b;
  }
  let output1 = Compare1<string>('Deb', 'Sahoo');
  let output2 = Compare1<number>(5, 6);
  let output3 = Compare1<number>(5.5, 6.8);
  let output4 = Compare1<any>(5.0, 5);
  let output5 = Compare1<any>('5.0', 5);