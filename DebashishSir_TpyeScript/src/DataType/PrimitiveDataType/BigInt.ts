export{};
//The bigint is a new primitive type in Typescript. It is available only if you target esnext in tsconfig.json. 
//it represents the whole number. It can hold numbers larger than 253 – 1. The BigInt uses the arbitrary-precision arithmetic.
//Defining bigint
...
let big2: bigint =BigInt( 9007199254740991n);
console.log(typeof big1);
