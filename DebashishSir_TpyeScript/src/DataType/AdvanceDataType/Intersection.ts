export {};
//Intersection types allow us to combine two or more types into one. 
//The resulting type will have all the properties of all the types. 
...
interface Person1 {
  ...
  let student3: Student1 & Person1 = {
    studentCode: '1',
    division: '10',
    name: 'rahul',
    age: 20,
  };
  let student4: Student1 & Person1 = {
    studentCode: '1',
    division: '10',
    name: 'rahul',
    age: 20, //ERROR
