...
enum BTECH {
  ...
  console.log(VehcileType4.Plane1); //1
  console.log(VehcileType4['Plane1']); //1
  console.log(VehcileType4[1]); //Plane
  
  //Get the name from the Enum Member.
  console.log(VehcileType4[VehcileType4.Plane1]); //Plane
  ...
  console.log(VehcileType1);
  
  function getVehicle(name: string): VehcileType1 | undefined {
    if (name === 'ferrari') {
      return VehcileType1.Car;
    } else {
      return undefined;
    }
  }
