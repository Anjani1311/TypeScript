//TypeScript Literal Types restrict the value of a variable to finite valid values. 
//This is in contrast to the variable which allows you to change value (except for TypeScript Constants). 
//The latest version of Typescript supports the String Literal Types, Numeric Literal Types, Boolean Literal Types & Enum Literal Types

//A literal is a notation for representing a fixed value in the source code. 
//For Example, 1 is literal, because it represents the number 1.
// hello is literal because it represents the string “hello”. Similarly null is literal because it represents the value null.
