//Bitwise Operators
//Bitwise operators operate on Binary numbers i.e. zeros & ones.
// Hence it is important to understand how they are stored to understand the Bitwise operators

//A binary number is a number expressed in the base-2 numeral system or binary numeral system. 
//It uses the 0 (zero) and 1 (one) to represent the numbers.
export {};
